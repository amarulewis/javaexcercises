...
import lewis.DBSUPPORT.LoginDao;
...
public class VaPa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet VaPa</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet VaPa at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(LoginDao.validate(username,password)){
            ...
            out.println("<center><h1>Sorry username and password inccorrect</h1></center>");
